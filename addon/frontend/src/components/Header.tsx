  ...
  return (
    <header className="paketti-header">
      <div className="paketti-header__left">
        <h1 className="paketti-header__title" onClick={() => navigate("/")}>
          Paketti Tracker
        </h1>
      </div>
      <div className="paketti-header__right">
        <button
        ...
        >
          <svg viewBox="0 0 24 24" width="20" height="20" className={state.refreshing ? "spin" : ""}>
            <path
              fill="currentColor"
